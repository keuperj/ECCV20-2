...
\begin{table*}
	...
	\begin{center}
		...
		\end{tabular}
	\caption{Tracking result compared to other methods on the MOT17 dataset. The best performance is marked in bold. \AK{In column "MT"  there is not any bold number}}
